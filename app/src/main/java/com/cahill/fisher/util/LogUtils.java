...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MyApp.getMyApplicationContext()
                    .getPackageManager()
                    .getPackageInfo(MyApp.getMyApplicationContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApp.getMyApplicationContext().getExternalCacheDir() != null)
                sDefaultDir = MyApp.getMyApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = MyApp.getMyApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
